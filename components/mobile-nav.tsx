...
import { Award, HelpCircle, Newspaper, LogIn } from "lucide-react"
...
export function MobileNav() {
  return (
    <nav className="fixed bottom-4 left-4 right-4 bg-white border-t border-gray-200 shadow-lg md:hidden z-50 rounded-2xl">
