...
export function RegisterFooter() {
  return (
    <footer className="bg-[#1a237e] text-white rounded-t-[3rem] lg:rounded-t-[4rem]">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-[#1a237e] font-semibold rounded-full bg-transparent px-6 py-3 flex-1 w-full"
              >
                Member Login
